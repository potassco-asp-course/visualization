\begin{tikzpicture}[]
    ...
    \only<2,3,4,5->{
        \node[] (lst-i) at(3.63,4.5) {
            \lstinputlisting[basicstyle=\tiny\ttfamily,linewidth=5.5cm]{listings/sudoku-instance.lp}
        };
    }
    \only<3,4,5->{
        \node[] (lst-e) at(4.7,3) {
            \lstinputlisting[basicstyle=\tiny\ttfamily,linewidth=5.5cm]{listings/sudoku-encoding.lp}
        };
        \draw[arrw] (user)  -- (lst-e);
    }
    \only<4>{
        \node[] (clingo-out) at(10.5,3) {
        \lstinputlisting[basicstyle=\tiny\ttfamily,linewidth=3cm]{listings/sudoku-out.txt}
        };
